                ...
                <div class="container flex flex-wrap justify-between items-center mx-auto">
                    ...
                    <div class="flex items-center md:order-2">
                        <div class="hidden relative mr-3 md:mr-0 md:block">
                            ...
                            <input type="text" id="email-adress-icon" class="rounded-full block p-2 pl-6 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." />
                        </div>
                        <button class="rounded-full bg-indigo-700 text-white px-5 py-2 ml-4">Upload</button>
                        <button class="rounded-full border-2 border-indigo-700 text-indigo-700 px-5 py-2 ml-4">Connect Wallet</button>
                    ...
                    <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-3">
                        <a href="https://flowbite.com" class="flex items-center mr-20">
                            ...
                            <h1 class="text-indigo-700 font-extrabold self-center text-xl font-semibold whitespace-nowrap dark:text-white">NFTERS</h1>
                        </a>
